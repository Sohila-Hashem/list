 ...
 */
export default class ListTabulator2<Renderer extends ListRenderer> {
  /**
   * The Editor.js API
   */
  private api: API;
  ...
  private parseListElement(element: HTMLElement): ListItem[] {
    console.log("🚀 ~ ListTabulator2 ~ parseListElement ~ element:", element)
    const items: ListItem[] = [];
    const liElements = Array.from(element.children).filter(
      (child) => child.tagName === 'LI'
    ) as HTMLElement[];
    console.log("🚀 ~ ListTabulator2 ~ parseListElement ~ liElements:", liElements)

    for (const li of liElements) {
      console.log("🚀 ~ ListTabulator2 ~ parseListElement ~ li:", li)
      let content = '';
      let meta = {};
      ...
      for (const node of childNodes) {
        console.log("🚀 ~ ListTabulator2 ~ parseListElement ~ node:", node)
        ...
        if (
          ...
          console.log("🚀 ~ ListTabulator2 ~ parseListElement ~ nestedList:", nestedList)
          break;
        }
        ...
        console.log("🚀 ~ ListTabulator2 ~ parseListElement ~ content:", content)
      }
      ...
      console.log("🚀 ~ ListTabulator2 ~ parseListElement ~ children:", children)
      ...
      console.log("🚀 ~ ListTabulator2 ~ parseListElement ~ items:", items)
    }
